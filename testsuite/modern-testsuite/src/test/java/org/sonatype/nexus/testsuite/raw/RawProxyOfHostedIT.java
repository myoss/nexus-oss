    ...
    extends RawITSupport
{
  ...
  public void createHostedRepository() throws Exception {
    ...
    hostedClient = new RawClient(clientBuilder().build(), clientContext(), hostedRepoUrl.toURI());
    ...
    URL proxyRepoUrl = repositoryBaseUrl(proxyRepo);
    proxyClient = new RawClient(clientBuilder().build(), clientContext(), proxyRepoUrl.toURI());
  }
